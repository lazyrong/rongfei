...
<head>
    ...
    <meta name="description" content="微信列表">
    ...
    <div class="animated fadeInRight">
        ...
        <div class="panel panel-default">
            <div class="panel-body filter-box">
             <p><strong>价格筛选：</strong> <a href="<?php echo U('Admin/List/index',array('cat_id'=>$cat_id));?>" >不限</a> <a href="<?php echo U('Admin/List/index',array('cat_id'=>$cat_id, 'startPrice'=>0,'endPrice'=>20 ));?>">0-20元</a>
            ...
            <p>
                <strong>粉丝量：</strong> <a href="<?php echo U('Admin/List/index',array('cat_id'=>$cat_id));?>">不限</a> <a href="<?php echo U('Admin/List/index',array('cat_id'=>$cat_id, 'startNum'=>0,'endNum'=>10 ));?>">10万以下</a>
            ...
            <form  class="form-horizontal row-fluid clearfix" role="form" id="form0">
              <!-- 选择分类 -->
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                      <label for="fans_num"   class="control-label">粉丝数量(个)</label>
                ...
                <div class="col-sm-offset-1 col-sm-3">
                        ...
                        <input type="text"  class="form-control" id="name" name="name"  placeholder="微信名称"  >
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm-offset-1 col-sm-3">    
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="wechat_id"  name="wechat_id" placeholder="微信号">
                    </div>                

                    <div class="form-group">
                        <label for="wx_type"   class="control-label">类型</label>
                        <input type="text"  class="form-control" id="wx_type" name="wx_type"  placeholder="类型"  >
                    </div>
                    <div class="form-group">
            ...
            <table class="table table-bordered table-hover text-center vertical-middle-lg">
                ...
                <tbody>
                    <?php if(is_array($resultList)): foreach($resultList as $k=>$res): ?><tr>
                            <td>
                                <input type="checkbox" name="ids[]" value="<?php echo ($res["wx_id"]); ?>">
                                <?php echo ($res["wx_id"]); ?>
                            </td>                      
                            <td>
                                <?php echo ($res["name"]); ?>
                            ...
                            <td><a href="<?php echo U('Admin/Wx/editWx',array('wx_id'=>$res[wx_id],'cat_id'=>$cat_id));?>" title="编辑"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;<a href="<?php echo U('Admin/Wx/del',array('wx_id'=>$res[wx_id]));?>" title="删除"><span class="glyphicon glyphicon-trash"></span></a></td>
    ...
    $(function() {
        ...
        $('#delAll').on('click', function() {
            ...
            var index = layer.confirm('删除全部所选内容？', {
                ...
                $.post('<?php echo U('Admin/Wx/delAll');?>', {'ids': arr},
                    function(st) {
                        layer.close(index);
                        if (st) {
                            layer.msg('删除成功!');
        ...
        $('#add0').click(function(){
          ...
          $.post("<?php echo U('Admin/Wx/add');?>", $formdata,
          function(st){
            if(parseInt(st) == 1) {
                // layer.msg('新增成功!');
                // //清空表单
